...
const ImageGallery = {
  highlight: document.querySelector('.gallery .highlight > img'),//imagem principal
  previews: document.querySelectorAll('.gallery-preview img'), //imagens
  ...
  setImage(e){
    ...
    ImageGallery.highlight.src = target.src //pegeue a imagem principal e coloque o alvo
